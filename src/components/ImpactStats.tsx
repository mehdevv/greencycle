      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-6xl md:text-7xl text-slate-900 tracking-tighter">
            Estimated <span className="text-emerald-600">Impact</span>
          </h2>
          <p className="text-xl text-slate-600 max-w-2xl mx-auto tracking-wide leading-relaxed">
            Projected outcomes based on our launch goals - all numbers are estimates
          </p>
        </motion.div>
                ...
                <div className="relative bg-white border border-slate-200 rounded-2xl p-12 transition-all duration-300 overflow-hidden">
                  ...
                  <div className="relative space-y-8">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-slate-500 tracking-wide uppercase text-xs">
                        {stat.label} <span className="text-slate-400">(est.)</span>
                      </div>
                    </div>
        ...
        >
          ...
          <p className="text-slate-600 text-lg tracking-wide">
            Our projected impact estimates preventing over <span className="text-emerald-600">12,500 kg of CO₂</span> from entering the atmosphere based on our launch goals.
          </p>
        </motion.div>
      </div>
    </section>
