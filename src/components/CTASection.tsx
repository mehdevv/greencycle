      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="text-emerald-700 tracking-wide uppercase text-sm">Join 15,000+ Active Users <span className="text-emerald-600">(est.)</span></span>
          </motion.div>
          ...
          <div className="grid grid-cols-3 gap-12 pt-12 border-t border-slate-200">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-slate-500 tracking-wide uppercase">Partner Locations <span className="text-slate-400">(est.)</span></div>
            </div>
            <div className="space-y-2">
