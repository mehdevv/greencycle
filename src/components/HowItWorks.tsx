          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  <div className="relative bg-white border border-slate-200 rounded-2xl p-12 transition-all duration-300 h-full flex flex-col">
                    ...
                    <div className="space-y-8 pt-8 flex-1 flex flex-col">
                      {/* Icon */}
